  ...
  const benefits = [
    {
      ...
      description:
        "Aggiungi un nuovo servizio ad alto margine al tuo portfolio",
    },
    {
      icon: Users,
      title: "Clienti Fidelizzati",
      description:
        "Offri un servizio continuativo che genera ricavi ricorrenti",
    },
    {
      icon: Award,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Unisciti alla nostra rete di partner autorizzati e offri ai tuoi
            clienti la tecnologia di sicurezza più avanzata del mercato.
          </p>
        </div>
        ...
        <div className="bg-blue-600 rounded-2xl p-8 text-white text-center">
          <h3 className="text-2xl font-bold mb-8">La Nostra Rete di Partner</h3>
            ...
            {[
              {
                step: "1",
                title: "Candidatura",
                desc: "Compila il form di richiesta informazioni",
              },
              {
                step: "2",
                title: "Valutazione",
                desc: "Analizziamo la tua candidatura e territorio",
              },
              {
                step: "3",
                title: "Formazione",
                desc: "Training su prodotti e procedure",
              },
              {
                step: "4",
                title: "Attivazione",
                desc: "Inizi a vendere e installare i nostri sistemi",
              },
            ].map((item, index) => (
